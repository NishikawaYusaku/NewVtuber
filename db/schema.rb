...
ActiveRecord::Schema[7.1].define(version: 2026_05_08_094738) do
  ...
  create_table "notifications", force: :cascade do |t|
    ...
    t.index ["vtuber_id"], name: "index_notifications_on_vtuber_id"
  end
  ...
  create_table "vtuber_tags", force: :cascade do |t|
    ...
    t.index ["vtuber_id", "tag_id"], name: "index_vtuber_tags_on_vtuber_id_and_tag_id", unique: true
  ...
  create_table "vtuber_youtubes", force: :cascade do |t|
    ...
    t.string "channel_id"
    t.index ["channel_id"], name: "index_vtuber_youtubes_on_channel_id", unique: true
